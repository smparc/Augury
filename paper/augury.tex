...
\addplot3[surf, shader=interp, mesh/ordering=rowwise, mesh/cols=26]
...
\node[font=\footnotesize, white, anchor=west] at (axis cs:1,0.015,10) {baseline: 6.00\,h};
\node[font=\footnotesize, augRed, anchor=south west] at (axis cs:0.6,0.052,10) {$\theta = 0.05$};
\node[font=\footnotesize, augRed, anchor=south west, rotate=90] at (axis cs:15.6,0.10,10) {$\kappa r_{\text{base}} = 15$};
\end{axis}
\end{tikzpicture}
